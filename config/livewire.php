...
return [
    ...
    | and also where component classes get stored within your application.
    |
    */
    ...
    */
    ...
    | In this case, the view returned by CreatePost will be rendered into
    | the 'content' section of this layout.
    |
    */
